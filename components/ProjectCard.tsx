...
const ProjectCard = ({ title, description, img }: ProjectCardProp) => {
  return (
    <div className=" m-1 bg-white rounded-lg p-1 flex flex-col justify-center items-center transform transition-transform duration-300 hover:translate-y-1 cursor-pointer">
      <Image
        src={img}
        alt="projectImg"
        height={300}
      ...
      <p className={`text-black-color  text-xs w-56 m-1 p-1`}>{description}</p>
